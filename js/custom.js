...
document.getElementById('carouselExampleControls22').addEventListener('touchstart', function (event) {
    event.preventDefault();
  });

document.getElementById('carouselExampleControls222').addEventListener('touchstart', function (event) {
    event.preventDefault();
  });