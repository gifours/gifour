...
document.getElementById('prevButton').addEventListener('click', function (e) {
    e.preventDefault();
    $('#carouselExampleControls222').carousel('prev');
  });

  document.getElementById('nextButton').addEventListener('click', function (e) {
    e.preventDefault();
    $('#carouselExampleControls222').carousel('next');
  });

document.getElementById('prevButton').addEventListener('click', function (e) {
    e.preventDefault();
    $('#carouselExampleControls22').carousel('prev');
  });

  document.getElementById('nextButton').addEventListener('click', function (e) {
    e.preventDefault();
    $('#carouselExampleControls22').carousel('next');
  });